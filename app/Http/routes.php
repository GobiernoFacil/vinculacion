...
Route::group(['middleware' => ['auth']], function () {
  ...
  */
  Route::group([ 'middleware' => 'type:opd' ], function(){
    ...
    Route::get("tablero-opd/empresas/todas", "Opds@companiesAll");
    ...
    Route::get("tablero-opd/empresas/activar/{id}", "OpdCompanies@enableToggle");
  ...
  */
  Route::group(['middleware' => 'type:student' ], function(){
    ...
    Route::get("tablero-estudiante/cv/descargar", "StudentCv@download");
