...
class OnlyAdminSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      // [2] crea el super admin principal. Si no se define en el .env, toma los valores de default
        $admin = new User();
        $admin->name     =  env('ADMIN_NAME', "Alfonso Arenas");
        $admin->email    =  env('ADMIN_EMAIL', "alfonso.arenas@puebla.gob.mx");
        $admin->password =  Hash::make(env('ADMIN_PASSWORD', "alfonso.arenas3mpl3oUn1v3rs1tar1o"));
