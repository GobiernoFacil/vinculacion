...
@section('breadcrumb_o', 'empresa actualizar')
...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-6 col-sm-offset-3">
      {!! Form::model($company->company, ['url' => "tablero-opd/empresa/editar/{$company->id}", "class" => "form-horizontal",'files'=>true]) !!}
      ...
      <fieldset>
        ...
        <p>
          <label>Tipo</label>
          {{Form::text('type', $company->type,["class" => "form-control"])}}
          @if($errors->has('type'))
