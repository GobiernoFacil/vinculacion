...
@section('description', 'Actualizar convenio en plataforma de Gobierno del Estado de Puebla')
@section('bodyclass', 'opd convenios')
@section('breadcrumb', 'layouts.breadcrumb')
@section('breadcrumb_o', 'convenio actualizar')
...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-6 col-sm-offset-3">
      {!! Form::model("",['url' => "tablero-opd/convenio/editar/$contract->id", "class" => "form-horizontal"]) !!}
