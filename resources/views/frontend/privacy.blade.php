...
<div class="container">
	<div class="col-sm-10 col-sm-offset-1">
		<h1 class="separator">Aviso de protección de datos</h1>
	
		<p>Los datos personales que Usted proporcione serán utilizados con confidencialidad, conforme a las normas legales aplicables y se almacenarán con las medidas de seguridad necesarias para garantizar su protección, conforme a la Ley de Protección de Datos Personales en Posesión de los Sujetos Obligados del Estado de Puebla. Ninguna persona que no esté autorizada podrá conocer sus datos personales.</p>
		<p>Los datos que Usted proporcione se conservarán en sistemas de Datos Personales para fines de registro, seguimiento y control de la población atendida y beneficiada por los programas, servicios y estrategias para los que se utiliza el presente portal, así como para fines estadísticos, históricos o científicos a cargo de la Secretaría de Educación Pública del Estado de Puebla, o de la Institución Educativa a la que Usted pertenece.</p>
