...
@section('breadcrumb_a', 'vacante edit')
  ...
  <div class="row">
    <div class="col-sm-6 col-sm-offset-3">
      ...
      <fieldset>
        ...
        {{Form::hidden('company_id',null,["class" => "form-control", "id" => "company_id"])}}
        <p>
          <label>Empresa</label>
          {{Form::text('company',$vacancy->company->nombre_comercial,["class" => "form-control", "id" => "company"])}}
