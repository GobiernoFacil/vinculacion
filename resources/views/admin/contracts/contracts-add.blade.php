...
@section('title', 'Agregar convenio')
@section('description', 'Agregar convenio de Universidad del Gobierno del Estado de Puebla')
@section('bodyclass', 'opds')
@section('breadcrumb', 'layouts.breadcrumb')
@section('breadcrumb_a', 'opds add-contratos')
...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-12">
      <h1 class="separator">Agregar Convenio</h1>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-6 col-sm-offset-3">
      {!! Form::model("",['url' => "dashboard/convenio/crear/$opd_id", "class" => "form-horizontal"]) !!}
      ...
      <fieldset>
        ...
        <p>
          ...
          {{Form::text('contract_name','',["class" => "form-control"])}}
        ...
        <p>
          ...
          {{Form::textarea('contract_objective','',["class" => "form-control"])}}
        ...
        <p>
          ...
          {{Form::textarea('contract_description','',["class" => "form-control"])}}
        ...
        <p>
          ...
          {{Form::number('contract_benefit_students','',["class" => "form-control"])}}
        ...
        <p>
          ...
          {{Form::number('contract_benefit_teachers','',["class" => "form-control"])}}
        ...
        <p>
          ...
          {{Form::number('contract_participant_students','',["class" => "form-control"])}}
        ...
        <p>
          ...
          {{Form::number('contract_participant_teachers','',["class" => "form-control"])}}
        ...
        <p>
          ...
          {{Form::text('contract_federal_budget','',["class" => "form-control"])}}
        ...
        <p>
          ...
          {{Form::text('contract_state_budget','',["class" => "form-control"])}}
        ...
        <p>
          ...
          {{Form::text('contract_own_budget','',["class" => "form-control"])}}
        ...
        <p>
          ...
          {{Form::text('contract_funding_source','',["class" => "form-control"])}}
        ...
        <p>
          ...
          {{Form::text('contract_signature_date','',["class" => "form-control"])}}
        ...
        <p>
          ...
          {{Form::text('contract_expiry_date','',["class" => "form-control"])}}
      ...
      <fieldset>
        ...
        <p>
          <label>Nombre</label>
          {{Form::text('contract_responsable_name','',["class" => "form-control"])}}
        ...
        <p>
          <label>Correo</label>
          {{Form::email('contract_responsable_email','',["class" => "form-control"])}}
