  ...
  <div class="row">
    <div class="col-sm-6 col-sm-offset-3">
      ...
      <fieldset>
        ...
        <p>
          <label>Nombre</label>
          {{Form::text('cname', $opd->opd->contact->name,["class" => "form-control"])}}
          @if($errors->has('cname'))
        ...
        <p>
          ...
          {{Form::text('cphone', $opd->opd->contact->phone,["class" => "form-control"])}}
        ...
        <p>
          <label>Correo</label>
          {{Form::text('cemail', $opd->opd->contact->email,["class" => "form-control"])}}
